...
create or replace PACKAGE BODY pck_extract IS
   ...
   BEGIN
      ...
      -- EXTRACT FROM SOURCE TABLES
        ...
        table_extract('EI_SAD_PROJ_BDA.T_BDA_AVALIACOES','t_data_avaliacoes','cd_aluno,cd_lectivo,cd_duracao,cd_curso_aluno,cd_discip,cd_plano,cd_epoca_aval,ds_epoca_aval,nr_avalia','cd_aluno,cd_lectivo,cd_duracao,cd_curso_aluno,cd_discip,cd_plano,cd_epoca_aval,ds_epoca_aval,nr_avalia');
        ...
        table_extract('EI_SAD_PROJ_BDA.T_BDA_CURSOS','t_data_cursos','cd_curso,cd_oficial,nm_curso,nm_cur_abr,cd_instituic,cd_regime,ds_grau,cd_activo,cd_bolonha','cd_curso,cd_oficial,nm_curso,nm_cur_abr,cd_instituic,cd_regime,ds_grau,cd_activo,cd_bolonha');
